...
public class loginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String password = request.getParameter("cus_pwd");
		
		boolean isTrue;
		
		isTrue = RecipientDBUtil.validate(userName, password);
		
		if(isTrue == true) {
			
			List <LoginRecipient> RecDetails = RecipientDBUtil.getLog_Recipient(userName);
